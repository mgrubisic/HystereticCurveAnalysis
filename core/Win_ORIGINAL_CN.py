...
class MainWin(QMainWindow):
    ...
    u1, u2, u3, u4, u5, u6, u7, u7_1 = None, None, None, None, None, None, None, None  # Displacement data
    F1, F2, F3, F4, F5, F6, F7, u7_1 = None, None, None, None, None, None, None, None  # Force Data
    d1, d2, d3, d4, d5, d6, d7, d7_1 = None, None, None, None, None, None, None, None  # Additional data，ndarray，It will be treated along with displacement and force.
    ok1, ok2, ok3, ok4, ok5, ok6, ok7, ok7_1 = False, False, False, False, False, False, False, False
    u_import, F_import = False, False  # Does displacement or force data exist?
    d_import = False  # Is there any additional data?
    pg_antialias = False
